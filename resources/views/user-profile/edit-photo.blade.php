...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{ isset(Auth::user()->photo) ? asset('storage/profile/'.Auth::user()->photo) : asset('storage/profile/default.jpg') }}" class="d-block w-50 mx-auto rounded-circle my-3" alt="">
