...
@section("title") <title>Article List</title> @endsection
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="">
                            <a href="{{ route('articles.create') }}" class="btn btn-lg btn-outline-primary mr-3">
                                <i class="feather-plus-circle"></i>
                                Create Article
                            </a>
                            @isset(request()->search)
                                <a href="{{ route('articles.index') }}" class="btn btn-lg btn-outline-dark mr-3">
                                    <i class="feather-list"></i>
                                    All Article
                                </a>
                        ...
                        <form action="{{ route('articles.index') }}" class="mb-3" method="get">
                            <div class="row g-2">
                                <div class="col-auto">
                        ...
                        @forelse($articles as $article)
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <a href="{{ route('articles.show', [$article->id, 'page'=> request()->page]) }}" class="btn btn-outline-success">
                                        Detail
                                    </a>
                                    <a href="{{ route('articles.edit',$article->id) }}" class="btn btn-outline-primary">
                                        Edit
                                    </a>
                                    <form action="{{ route('articles.destroy',[$article->id,'page'=>request()->page]) }}" class="d-inline-block" method="post">
                                        @csrf
                                        @method('delete')
