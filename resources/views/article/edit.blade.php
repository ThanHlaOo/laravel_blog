...
@section("title") <title> Edit Article</title> @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('articles.update',$article->id) }}" id="editArticle" method="post">
                        @csrf
                        @method("put")
                    </form>
                </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <div class="form-group mb-0">
                        ...
                        <select name="category" form="editArticle"  class="form-select @error('category') is-invalid @enderror " id="">
